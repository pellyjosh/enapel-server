...
import {getAppPath, getDefaultEnvironmentVariables, getDefaultPhpIniSettings, runningSecureBuild, usesBundledPhar} from "../php.js";
...
function startPhpProcess(settings) {
    ...
    if (settings.cmd[0] === 'artisan' && usesBundledPhar()) {
