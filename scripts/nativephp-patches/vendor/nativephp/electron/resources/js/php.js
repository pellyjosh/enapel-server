...
// Use architecture-specific subfolder to support universal builds
const archFolder = (platform.os === 'mac') ? platform.arch : ''; 
const binaryDestDir = join(import.meta.dirname, 'resources/php', archFolder);
...
if (platform.phpBinary) {
    try {
        ...
        // Only remove the specific architecture folder, not the parent
