...
class Application extends Container implements ApplicationContract, CachesConfiguration, CachesRoutes, HttpKernelInterface
{
    ...
    protected function normalizeCachePath($key, $default)
    {
        ...
        // Patch: Correctly identify Windows absolute paths (e.g., C:\...) 
        // to prevent incorrect concatenation with basePath.
        $isAbsolute = Str::startsWith($env, $this->absoluteCachePathPrefixes)
            || (PHP_OS_FAMILY === 'Windows' && preg_match('/^[a-zA-Z]:\\\\/', $env));
