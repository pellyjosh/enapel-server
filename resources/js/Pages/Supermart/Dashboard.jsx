        ...
        <div className="py-8 px-4 sm:px-6 lg:px-8  space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Link href={route('supermart.catalog')} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-emerald-500/30 transition-all flex items-center gap-2 text-sm md:text-base">
                    ...
                    <Link href={route('supermart.pos')} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-blue-500/30 transition-all flex items-center gap-2 text-sm md:text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-indigo-500 to-blue-600 p-6 rounded-3xl text-white shadow-xl shadow-blue-500/20 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black mb-1">{metrics?.total_sales ?? 0}</h3>
                        <p className="font-medium text-blue-100 mb-6 font-bold tracking-tight uppercase text-xs">Total Sales Transactions</p>
                        
                        <Link href={route('supermart.reports')} className="text-blue-600 text-xs font-black bg-white px-4 py-2 rounded-xl group-hover:scale-105 transition-all uppercase tracking-widest inline-block">
                            View Reports
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-500 to-amber-500 p-6 rounded-3xl text-white shadow-xl shadow-orange-500/20 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black mb-1">{metrics?.low_stock ?? 0}</h3>
                        <p className="font-medium text-orange-100 mb-6 font-bold tracking-tight uppercase text-xs">Low Stock Alerts</p>
                        
                        <Link href={route('supermart.catalog')} className="text-white text-xs font-black bg-white/20 px-4 py-2 rounded-xl group-hover:bg-white/30 transition-colors uppercase tracking-widest">
                            Inventory
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-xl shadow-gray-200/40 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black text-gray-900 mb-1">{metrics?.out_of_stock ?? 0}</h3>
                        <p className="font-medium text-gray-500 mb-6 font-bold tracking-tight uppercase text-xs">Out of Stock Items</p>
                        
                        <Link href={route('supermart.catalog')} className="text-rose-600 text-xs font-black bg-rose-50 px-4 py-2 rounded-xl hover:bg-rose-100 transition-colors uppercase tracking-widest">
                            Restock &rarr;
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-xl shadow-gray-200/40 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black text-gray-900 mb-1">{metrics?.total_products ?? 0}</h3>
                        <p className="font-medium text-gray-500 mb-6 font-bold tracking-tight uppercase text-xs">Total Store Items</p>
                        
                        <Link href={route('supermart.catalog')} className="text-emerald-600 text-xs font-black bg-emerald-50 px-4 py-2 rounded-xl hover:bg-emerald-100 transition-colors uppercase tracking-widest">
                             Catalog &rarr;
                        </Link>
                    </div>
                </div>
