        ...
        <div className="py-8 px-4 sm:px-6 lg:px-8  space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Link href={route('pharmacy.catalog')} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-emerald-500/30 transition-all flex items-center gap-2">
                    ...
                    <Link href={route('pharmacy.pos')} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-blue-500/30 transition-all flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-red-500 to-rose-600 p-6 rounded-3xl text-white shadow-xl shadow-red-500/20 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <Link href={route('pharmacy.catalog')} className="text-white text-xs font-black bg-white/20 px-4 py-2 rounded-xl group-hover:bg-white/30 transition-colors uppercase tracking-widest">
                            Manage Batch
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-xl shadow-gray-200/40 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <Link href={route('pharmacy.prescriptions')} className="text-indigo-600 text-xs font-black bg-indigo-50 px-4 py-2 rounded-xl hover:bg-indigo-100 transition-colors uppercase tracking-widest">
                            Dispense Now &rarr;
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-xl shadow-gray-200/40 relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <Link href={route('pharmacy.catalog')} className="text-emerald-600 text-xs font-black bg-emerald-50 px-4 py-2 rounded-xl hover:bg-emerald-100 transition-colors uppercase tracking-widest">
                            View Catalog &rarr;
                        </Link>
                    </div>
                </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-3xl p-8 text-center mt-12">
                ...
                <Link href={route('pharmacy.catalog')} className="text-sm font-bold bg-gray-900 hover:bg-black text-white px-6 py-3 rounded-xl transition-colors inline-block">
                    Add First Drug
                </Link>
            </div>
        </div>
