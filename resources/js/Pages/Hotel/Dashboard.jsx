        ...
        <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Link href="/hotel/bookings" className="bg-indigo-600 hover:bg-black text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-indigo-500/20 transition-all flex items-center gap-2">
                        + New Booking
                    </Link>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white border border-gray-100 p-6 rounded-[32px] shadow-xl shadow-gray-200/40 group hover:border-indigo-500/30 transition-all border-b-4 border-b-indigo-500">
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-[32px] shadow-xl shadow-gray-200/40 group hover:border-rose-500/30 transition-all border-b-4 border-b-rose-500">
                    <div className="bg-rose-50 text-rose-600 w-12 h-12 rounded-2xl flex items-center justify-center mb-6">
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-[32px] shadow-xl shadow-gray-200/40 group hover:border-emerald-500/30 transition-all border-b-4 border-b-emerald-500">
                ...
                <div className="bg-white border border-gray-100 p-6 rounded-[32px] shadow-xl shadow-gray-200/40 group hover:border-orange-500/30 transition-all border-b-4 border-b-orange-500">
                ...
                <div className="relative z-10 md:flex items-center justify-between">
                    <div className="max-w-xl">
                        ...
                        <div className="flex gap-4">
                            <Link href="/hotel/rooms" className="bg-white text-gray-900 px-8 py-3 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-indigo-400 transition-colors">Configure Rooms</Link>
                            <Link href="/hotel/housekeeping" className="bg-white/10 text-white px-8 py-3 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-white/20 transition-colors">Housekeeping</Link>
                        </div>
                    </div>
